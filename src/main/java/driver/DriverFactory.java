...
public class DriverFactory {
    ...
    public WebDriver getDriver (String browserName){
        ...
        if (OS.isFamilyMac()){
            edgeDriverLocation = "/src/test/resources/drivers/geckodriver.exe";
        } else if (OS.isFamilyWindows()) {
            edgeDriverLocation = "\\src\\test\\resources\\drivers\\msedgedriver.exe";
        } else {
            throw new RuntimeException("[ERR] Couldn't detect the OS");
        }
        String edgeDriverLocationAbsoluteLocation = currentProjectLocation.concat(edgeDriverLocation);
        if (driver == null) {
            switch (browserName) {
                case ("chrome"):
                    System.setProperty("webdriver.chrome.driver", chromeAbsoluteLocation);
                ...
                case ("firefox"):
                    ...
                    break;
                case ("edge"):
                    System.setProperty("webdriver.edge.driver", firefoxAbsoluteLocation);
